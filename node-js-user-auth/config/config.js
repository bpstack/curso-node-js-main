export const {
  ...
  SECRET_JWT_KEY = '', // No se recomienda poner un valor por defecto, para que así seguro no se olvide en producción (porque nos dará error) e inyectarselo como variable de entorno.
} = process.env
